...
with_ansible "kargo/cluster.yml --tags preinstall"

echo "Configuring DNS settings on nodes via ansible..."
# FIXME(bogdando) this hack skips k8s related part of setup, TBD split it in kargo
with_ansible "kargo/cluster.yml --tags dnsmasq -e inventory_hostname=skip_k8s_part"
