...
with_ansible $ADMIN_WORKSPACE/kargo/$KARGO_CLUSTER_YML --tags preinstall,dnsmasq -e skip_dnsmasq_k8s=true
...
if admin_node_command ansible-playbook -i $ADMIN_WORKSPACE/inventory \
