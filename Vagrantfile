...
export ADMIN_IP="#{ip}"
export IMAGE_PATH="#{$box}"
/vagrant/utils/packer/debian8.5/scripts/setup.sh
/vagrant/utils/packer/debian8.5/scripts/packages.sh
/vagrant/utils/jenkins/kargo_deploy.sh
SCRIPT
